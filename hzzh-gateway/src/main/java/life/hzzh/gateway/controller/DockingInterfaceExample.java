...
public class DockingInterfaceExample {
    ...
    public String getConfig(@RequestParam(value = "dataId", defaultValue = "hzzh-api-gateway.properties") String dataId,
    ...
    public boolean publishConfig(@RequestParam(value = "dataId", defaultValue = "hzzh-api-gateway.properties") String dataId,
                                 @RequestParam(value = "group", required = false, defaultValue = "DEFAULT_GROUP") String group,
    ...
    public boolean removeConfig(@RequestParam(value = "dataId", defaultValue = "hzzh-api-gateway.properties") String dataId,
                                @RequestParam(value = "group", required = false, defaultValue = "DEFAULT_GROUP") String group)
            throws NacosException {
        if (StringUtils.isEmpty(group)) {
            group = DEFAULT_GROUP;
    ...
    public String listenerConfig(@RequestParam(value = "dataId", defaultValue = "hzzh-api-gateway.properties") String dataId,
                                 @RequestParam(value = "group", required = false, defaultValue = "DEFAULT_GROUP") String group)
            throws NacosException {
        if (StringUtils.isEmpty(group)) {
            group = DEFAULT_GROUP;
